          ...
          <div className="flex-shrink-0 relative mt-8 md:mt-0">
            <div className="relative w-48 h-48">
              ...
              <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full">
                <path d="M 30,35 Q 30,25 40,25 L 60,25 Q 70,25 70,35 L 70,60 Q 70,70 65,75 Q 60,75 60,70 L 60,65 Q 55,70 50,70 Q 45,70 40,65 L 40,70 Q 40,75 35,75 Q 30,70 30,60 Z" fill="white" stroke="#00004d" strokeWidth="2" />
